...
const BrandLogo = styled(IconNextcalde)`
  margin: auto;
...
const SpinnerAnimation = styled.div`
  ...
  background-size:
    300% ${(props) => props.$size * 0.2}px,
    ${(props) => props.$size * 0.2}px 300%;
...
export function LoadingSpinner({ size, ...rest }) {
  return (
...
function LoadingComponent({ size, ...rest }) {
...
export const LOADING = (props) => <LoadingComponent size={100} {...props} />;
